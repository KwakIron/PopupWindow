package com.guozhe.android.popupwindow;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_show = (Button) findViewById(R.id.btn_shou);
    ...
    private void initPopWindow(View v) {
        ...
        popWindow.setBackgroundDrawable(new ColorDrawable(0x00000001));    //要为popWindow设置一个背景才有效
